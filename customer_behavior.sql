...
select * from customerbehaviour_cleaned;

select count(*) from customer_data;

DESCRIBE customerbehaviour_cleaned;

DROP TABLE customer_data;
RENAME TABLE customerbehaviour_cleaned to customer_data;
...
-- Q-2) which customers used a discount but still spend more than the average purchase amount?
...
-- Q-4) Compare the average purschase amounts between standard and express shipping.
...
select customer_segment, count(*) as "Number of cusomters"
from customer_type
